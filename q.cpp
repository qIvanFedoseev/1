...
int main()
{
...

     {
         ...
         //DrawPtica(x, 300,(x/10)%2, RGB(240,40,40), size, 1);
         //DrawPtica(800-x, 200, (x/10)%2, RGB(40,240,40), -size, 1);
         //Drawstvol(380, 560);
         Drawkrest();
         ...
         if ((x==txMouseX)&&(txMouseY==300))
         {
          DrawPtica(x, 300,(x/10)%2, RGB(240,40,40), 0, 0);
         }
         else
         {
          DrawPtica(x, 300,(x/10)%2, RGB(240,40,40), size, 1);
         ...
         if ((800-x==txMouseX)&&(txMouseY==200))
         {
          DrawPtica(800-x, 200, (x/10)%2, RGB(40,240,40), 0, 0);
         }
         else
         {
          DrawPtica(800-x, 200, (x/10)%2, RGB(40,240,40), -size, 1);
